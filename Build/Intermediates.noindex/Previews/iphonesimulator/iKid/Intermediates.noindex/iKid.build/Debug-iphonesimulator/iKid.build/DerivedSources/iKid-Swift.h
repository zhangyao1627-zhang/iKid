...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="iKid",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4iKid11AppDelegate")
...
SWIFT_CLASS("_TtC4iKid13SceneDelegate")
...
SWIFT_CLASS("_TtC4iKid14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIToolbar * _Null_unspecified toolBar;
@property (nonatomic, strong) IBOutlet UIView * _Null_unspecified toolView;
- (void)viewDidLoad;
- (void)toolbarItemTapped:(UIBarButtonItem * _Nonnull)sender;
